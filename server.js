    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;">
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(150deg,#0b1a30 0%,#0d2448 50%,#162d5e 100%);padding:40px 48px 36px;text-align:center;">
          ...
          <!-- Gold divider -->
          <tr>
            <td style="height:1px;background:rgba(201,168,76,.25);margin:0 48px;"></td>
          </tr>
...
app.listen(PORT, () => {
  console.log(`Fernvay lead form running at http://localhost:${PORT}`);
});
